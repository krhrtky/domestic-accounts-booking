# ジャーニーマップ：家族カードの使用分を明確に分担・精算する体験

| フェーズ           | 行動                                                                 | 課題・感情                                                   | タッチポイント                         | 解決策のアイデア例                                           |
|--------------------|----------------------------------------------------------------------|--------------------------------------------------------------|------------------------------------------|--------------------------------------------------------------|
| 認知（Before）     | ・家計を見直したい<br>・支出の偏りに気づく                          | ・毎月の支払いが不透明<br>・自分の分がいくらか分からない     | SNS/友人紹介/既存アプリ広告              | 「家族カードの分担に便利な家計簿アプリ」として訴求          |
| 興味・検討         | ・アプリを探す<br>・比較検討                                        | ・自分たちに合うかわからない                                | アプリストア、紹介記事、レビュー         | デモ画像・家族での使い方例を紹介                             |
